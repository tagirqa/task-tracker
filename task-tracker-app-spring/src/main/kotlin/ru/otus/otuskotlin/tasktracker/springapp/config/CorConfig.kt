...
//    fun appAuth(): AuthConfig = AuthConfig.NONE
    ...
    @Bean
    fun testRepository() = RepoTaskCassandra(keyspaceName = "test_keyspace", host = "0.0.0.0")

    @Bean
    fun stubRepository() = RepoTaskCassandra(keyspaceName = "test_keyspace", host = "0.0.0.0")
